SOURCES = oelam.vala oelam-help.vala oelam-run.vala oelam-create.vala oelam-debug.vala oelam-window.vala oelam-webview.vala oelam-config.vala oelam-utils.vala 
